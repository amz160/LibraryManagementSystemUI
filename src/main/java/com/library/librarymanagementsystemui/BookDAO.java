        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            ...
            try (PreparedStatement checkStmt = connection.prepareStatement(checkExistingTransaction)) {
                ...
                if (rs.next()) {
                    ...
                    return false; // Book is already borrowed by this patron
                }
            }
            ...
            try (PreparedStatement updateBookStmt = connection.prepareStatement(updateBookSql);
                ...
                // Update the book to indicate it is no longer available and set the due date
                ...
                connection.rollback();
                System.out.println("Error borrowing book (rolling back): " + e.getMessage());
                return false;
            } finally {
    ...
    public boolean returnBook(int bookID, int patronID) {
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            ...
            try (PreparedStatement updateBookStmt = connection.prepareStatement(updateBookSql);
                ...
                // Update the book to indicate it is available
